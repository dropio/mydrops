...
function DropioApiClient(the_api_key,the_xd_path,use_ajax) {
    ...
    ********************************/
    this.sendApiRequest = function(url,method,params,callback) {
      params = this.cleanParams(params);
      if( this.use_ajax ) this.sendAjaxRequest(url,method,params,callback)
      else this.sendAimRequest(url,method,params,callback);
    };
